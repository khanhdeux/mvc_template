...
class ContactController extends Controller {
    ...
    public function save() {
        ...
        $firstName = isset($_POST['first_name']) ? trim(htmlentities($_POST['first_name'])) : NULL;
        $lastName = isset($_POST['last_name']) ? trim(htmlentities($_POST['last_name'])) : NULL;
        $email = isset($_POST['email']) ? trim(htmlentities($_POST['email'])) : "";
        $message = isset($_POST['message']) ? trim(htmlentities($_POST['message'])) : "";
